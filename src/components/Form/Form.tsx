        ...
        <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <div className={styles.field}>
                ...
                <select  name="country" id="country" value={search.country} onChange={handleChange}>
                    <option className={styles.formOption} value="">--Seleccione un País--</option>
                    {countries.map( country => (
                        <option className={styles.formOption} key={country.code} value={country.code}>{country.name}</option>
                    ))}
                </select>
            </div>
